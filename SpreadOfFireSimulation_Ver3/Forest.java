...
public class Forest {
    ...
    public double calculatedTreeLeft(int lasttree , int initTree){
        double result = 1;
        double lastTree = (double) lasttree;
        double firstTree = (double) initTree;
        
        result = lastTree/firstTree*100;
    ...
    public double calculatedTreeBurned(double result){
